...
TRUNCATE TABLE WEB_CAR; -- TRUNCATE는 DDL이기 때문에 ROLLBACK이 불가능하다

--DROP TABLE WEB_ADDRESS CASCADE CONSTRAINTS;
--DROP TABLE WEB_BOOK CASCADE CONSTRAINTS;
DROP TABLE WEB_BOOKS CASCADE CONSTRAINTS;
DROP TABLE WEB_BOOKSPRICE CASCADE CONSTRAINTS;
DROP TABLE WEB_CAR CASCADE CONSTRAINTS;
--DROP TABLE WEB_CASE CASCADE CONSTRAINTS;
--DROP TABLE WEB_DEPT CASCADE CONSTRAINTS;
--DROP TABLE WEB_EMP CASCADE CONSTRAINTS;
DROP TABLE WEB_GRADE CASCADE CONSTRAINTS;
--DROP TABLE WEB_MEMBER CASCADE CONSTRAINTS;
DROP TABLE WEB_MEMBERS CASCADE CONSTRAINTS;
--DROP TABLE WEB_PHONE CASCADE CONSTRAINTS;
DROP TABLE WEB_RENTALS CASCADE CONSTRAINTS;
--DROP TABLE WEB_STU CASCADE CONSTRAINTS;
--DROP TABLE WEB_STUDENT CASCADE CONSTRAINTS;
